...
Module MailFSPathImpl' <:
  ...
  Definition compile_op T (op : MailFSStringOp.Op T) : proc _ T :=
    ...
    | MailFSStringOp.CreateTmp tmpfn => Call (MailFSPathOp.Create (tmp_string, tmpfn))
    | MailFSStringOp.WriteTmp tmpfn data => Call (MailFSPathOp.Write (tmp_string, tmpfn) data)
